        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-3">
          <div className="grid grid-cols-2 gap-4 lg:col-span-1">
            {githubStats.map((stat, i) => (
              <motion.div key={stat.label} initial={{ opacity: 0, y: 20, rotateX: -12 }} animate={inView ? { opacity: 1, y: 0, rotateX: 0 } : {}} transition={{ duration: 0.5, delay: i * 0.08 }} style={{ transformStyle: 'preserve-3d' }} className="perspective-1000">
                <TiltCard maxTilt={10} scale={1.05} className="h-full p-5 transition-shadow duration-300 hover:card-3d-shadow-hover">
          ...
          <motion.div initial={{ opacity: 0, y: 20, rotateX: -8 }} animate={inView ? { opacity: 1, y: 0, rotateX: 0 } : {}} transition={{ duration: 0.6, delay: 0.2 }} style={{ transformStyle: 'preserve-3d' }} className="perspective-1000 lg:col-span-2">
            <TiltCard maxTilt={6} scale={1.01} className="h-full p-6 transition-shadow duration-300 hover:card-3d-shadow-hover">
            <div className="mb-4 flex items-center justify-between" style={{ transform: 'translateZ(20px)' }}>
            ...
            <div className="overflow-x-auto" style={{ transform: 'translateZ(10px)' }}>

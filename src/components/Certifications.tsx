          ...
          {certifications.map((cert, i) => (
            ...
            >
              <div
                ...
                style={{ background: `${cert.color}40` }}
              />
              ...
              <h3 className="relative mt-4 font-display text-base font-semibold leading-snug text-white">
                {cert.title}
              </h3>
              <p className="relative mt-1 text-sm text-slate-400">{cert.issuer}</p>
              <span
                className="relative mt-3 inline-block rounded-full px-2.5 py-1 text-xs font-medium"

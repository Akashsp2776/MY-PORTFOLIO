        ...
        <div className="mt-16 relative">
          ...
          <div className="space-y-10">
            {education.map((edu, i) => (
              ...
              >
                <div className="absolute left-4 z-10 grid h-8 w-8 -translate-x-1/2 place-items-center rounded-full border bg-bg md:left-1/2" style={{ borderColor: `${edu.color}60` }}>
                  <div className="h-2.5 w-2.5 rounded-full" style={{ background: edu.color }} />
                </div>
                ...
                <div className={`ml-12 md:ml-0 md:w-1/2 ${i % 2 === 0 ? 'md:pr-12 md:text-right' : 'md:pl-12'}`}>
                  <div className="gradient-border p-6 transition-all duration-300 hover:scale-[1.02]">
                    <div className={`flex items-center gap-2 ${i % 2 === 0 ? 'md:justify-end' : ''}`}>
                      ...
                      <span className="font-mono text-xs uppercase tracking-wider" style={{ color: edu.color }}>
                        {edu.period}
                      </span>
                    </div>
